					...
					<div class="col-lg-8">
						<div class="chart-data-selector" id="salesSelectorWrapper">
							...
							<div id="salesSelectorItems" class="chart-data-selector-items mt-sm">
								...
								<div class="chart chart-sm" data-sales-rel="Transaksi" id="flotDashSales1" class="chart-active"></div>
								<script>
								...
								<div class="chart chart-sm" data-sales-rel="Nasabah" id="flotDashSales2" class="chart-hidden"></div>
								<script>
					...
					<div class="widget-summary widget-summary-md">
						...
						<div class="widget-summary-col">
							<div class="summary">
								...
								<div class="info">
									<strong class="amount">145 Transaksi</strong>
			...
			<!--<section class="panel panel-featured-left panel-featured-secondary">
				<div class="panel-body">
					<div class="widget-summary widget-summary-md">
						...
						<div class="widget-summary-col">
							<div class="summary">
								<h4 class="title">ntah</h4>
								<div class="info">
									<strong class="amount">50 ntah</strong>
								</div>
							</div>
						</div>
					</div>
